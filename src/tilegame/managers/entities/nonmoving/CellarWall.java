...
public class CellarWall extends Nonmoving{
	...
	*/
	...
	public void render(Graphics g) {
		g.drawImage(Assets.wall[type], (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height);
	...
	public void render(Graphics g, double scale) {
		...
		g.drawImage(Assets.wall[type], x, y, width, height);
