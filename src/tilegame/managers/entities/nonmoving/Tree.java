...
public class Tree extends Nonmoving{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.tree, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height);
	...
	public void render(Graphics g, double scale) {
		...
		g.drawImage(Assets.tree, x, y, width, height);
