...
public class Rock extends Nonmoving{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.rock, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height);
	...
	public void render(Graphics g, double scale) {
		...
		g.drawImage(Assets.rock, x, y, width, height);
